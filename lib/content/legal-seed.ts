...
const lastUpdated = "Last updated 15/07/2026. This draft must be approved with the client-specific facts before live payment is enabled.";
...
export const legalRawPages: PageContentInput[] = [
  {
    ...
    status: "published", sections: [
      ...
      { blockType: "feature_list", eyebrow: "What is handled", heading: "Information, purposes and limits", layout: "stack", tone: "white", items: [
        ...
        { title: "Marketing and minors", body: "Marketing consent is separate from booking consent and is not requested in this flow. The intended approach to children and guardian consent is pending client confirmation; bookings for minors must remain outside the live scope until approved." },
      ] },
      ...
      { blockType: "call_to_action", heading: "Questions should reach a named person", body: "The client must approve and publish a responsible party, Information Officer and privacy contact before launch.", action: { label: "Review booking information", href: "/book" } },
    ],
  },
  {
    ...
    status: "published", sections: [
      ...
      { blockType: "feature_list", eyebrow: "Using the service", heading: "How the proposed booking journey works", layout: "stack", tone: "cream", items: [
        ...
        { title: "Review and correct", body: "Before payment, review the service, Johannesburg appointment time and ZAR total. Return to the booking flow to correct a selection. Contact and correction channels are pending client confirmation." },
        ...
        { title: "Prices, ZAR and VAT", body: "Prices are recorded in South African rand. Whether displayed prices include VAT, and whether VAT applies, is pending client confirmation. No different amount may be substituted by the browser." },
      ...
      { blockType: "notice", heading: "Client facts and legal review are still required", body: ["Live payment must not be enabled until the provider identity, contact route, VAT position, delivery model, complaint process, cancellation rules and early-performance approach are approved."], tone: "verification" },
  ...
  },
  {
    ...
    description: "Draft cancellation, rescheduling and refund principles for Thrive Through Cancer bookings, pending client approval.",
    status: "published", sections: [
      { blockType: "introduction", eyebrow: "Cancellations and refunds", heading: "Fair rules need to be approved before payment opens", body: [lastUpdated, "The cancellation method, notice periods, reasonable charges, no-show rules, rescheduling limits, refund timing and support contact are all pending client confirmation. There is no blanket non-refundable term."], align: "left" },
      { blockType: "feature_list", eyebrow: "Proposed principles", heading: "What the final policy must cover", layout: "stack", tone: "white", items: [
        ...
        { title: "Death, hospitalisation and serious disruption", body: "The client asked for an exception for death or hospitalisation. The evidence, discretion and refund or reschedule outcome require humane, privacy-conscious wording and client approval." },
      ...
      { blockType: "notice", heading: "No refund promise is activated by this draft", body: ["Until the client approves the operational rules and contact method, EFT and live PayFast payment must remain disabled. Staff should not invent a refund outcome outside a documented, auditable process."], tone: "status" },
  ...
  },
  {
    ...
    status: "published", sections: [
      ...
      { blockType: "feature_list", eyebrow: "Important boundaries", heading: "Keep medical decisions with your healthcare team", layout: "stack", tone: "cream", items: [
        ...
        { title: "Urgent and emergency needs", body: "This service is not monitored for emergencies. Client-approved South African emergency and urgent mental-health instructions are still required before launch; no unverified number is invented here. If there is immediate danger, use an appropriate local emergency service or go to the nearest emergency facility." },
      ] },
      { blockType: "notice", heading: "Urgent-care facts require approval", body: ["The client must approve crisis boundaries, monitored contact hours, local emergency wording and referral arrangements before the booking service is promoted. The booking form must never be used to request urgent help."], tone: "verification" },
