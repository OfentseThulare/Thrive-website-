...
export function AdminShell({ identity, children }: { identity: CmsIdentity; children: React.ReactNode }) {
  const links = [
  ...
  return (
    <div className="admin-app">
      ...
      <div className="admin-workspace"><header className="admin-topbar"><Link href="/" target="_blank">View public website <span aria-hidden="true">↗</span></Link></header>{children}</div>
    </div>
  );
}
